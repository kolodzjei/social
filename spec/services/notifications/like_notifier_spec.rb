  ...
  describe "#notify" do
    ...
    context "when likeable is a reply" do
      context "and actor is the reply owner" do
        let(:likeable) { create(:reply, comment: create(:comment, post: create(:post, user: create(:user)), user: create(:user)), user: actor) }
      ...
      context "and actor is not the reply owner" do
        let(:likeable) { create(:reply, comment: create(:comment, post: create(:post, user: create(:user)), user: create(:user)), user: create(:user)) }
